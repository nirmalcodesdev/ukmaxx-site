...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const { cartItems, email, fullName, address, promoOptIn } = req.body || {};
    ...
    const shipping = 499;
    line_items.push({ price_data: { currency: 'gbp', product_data: { name: 'UK TRACKED SHIPPING', metadata: { sku: 'SHIPPING' } }, unit_amount: shipping }, quantity: 1 });
